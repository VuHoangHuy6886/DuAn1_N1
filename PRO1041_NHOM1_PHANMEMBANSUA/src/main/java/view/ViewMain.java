...
public class ViewMain extends javax.swing.JFrame {
    ...
    public ViewMain() {
        ...
        showTenNhanVien();
        JOptionPane.showMessageDialog(this , "CHAO MUNG BAN DEN VOI PHAN MEM BAN SUA !!");
    }

    public void showTenNhanVien() {
        int idNV = ViewLogin.idNhanVienKhiDangNhap;
        int ChucVu = ViewLogin.role;
        String chucVuNhanVien = "";
        if (ChucVu == 0) {
            chucVuNhanVien = "Quản Lý";
        } else if (ChucVu == 1) {
            chucVuNhanVien = "Nhân Viên";
        }
        listNv = service.listNhanVien();
        for (NhanVien nv : listNv) {
            if (nv.getIdNV() == idNV && nv.getChucVu() == ChucVu) {
                lbTenNhanVien.setText(nv.getTenNV());
                lbChucvu.setText(chucVuNhanVien);
            }
    ...
    private void initComponents() {
        ...
        jPanel3.add(menu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 200, 60));
        ...
        jPanel3.add(lbTenNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 90, -1));

        jLabel9.setText("Chức Vụ :");
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, -1, -1));

        lbChucvu.setText("Chức Vụ");
        jPanel3.add(lbChucvu, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 70, -1));
    ...
    private void menu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu1MouseClicked
        ...
        desktop.removeAll();
        desktop.add(hdv).setVisible(true);
    ...
    private void menu3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu3MouseClicked
        if (ViewLogin.role == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Bạn không phải quản lý");
            return;
        }
    ...
    private void menu5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu5MouseClicked
        VouCherView vc = new VouCherView();
        desktop.removeAll();
    ...
    private void menu7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu7MouseClicked
        QuanLySanPhamView sp = new QuanLySanPhamView();
        desktop.removeAll();
    ...
    private void jMenu4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu4MouseClicked
        ViewPhieuDoi phieuDoi = new ViewPhieuDoi();
        desktop.removeAll();;
        desktop.add(phieuDoi).setVisible(true);
    }//GEN-LAST:event_jMenu4MouseClicked

    private void jMenu3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu3MouseClicked
        ViewDotGiamGiaFinal d = new ViewDotGiamGiaFinal();
        desktop.removeAll();
        desktop.add(d).setVisible(true);
